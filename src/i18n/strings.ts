...
const en = {
  ...
  'settings.rightHandedTitle': 'Stock on the right, foundations on the left',
  'settings.leftHandedTitle': 'Stock on the left, foundations on the right',
...
const fr: Record<StringKey, string> = {
  ...
  'settings.rightHandedTitle': 'Pioche à droite, fondations à gauche',
  'settings.leftHandedTitle': 'Pioche à gauche, fondations à droite',
